                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="index.html"><img src="{{ asset('assets/imgs/logo/logo-1.JFIF') }}" alt="logo"
                                    width="120" height="150"></a>
                        </div>
                        <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated">Contact</h5>
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>Duong Van Nga Street
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+84 0000-000-000
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>xuantrung276@gmail.com
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">XuanTrung</strong> All rights reserved
                </p>
            </div>
        </div>
    </div>
