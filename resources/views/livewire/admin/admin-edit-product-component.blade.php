                            ...
                            <div class="card-body">
                                <form action="" wire:submit.prevent="updateProduct">
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea name="short_description" class="form-control" placeholder="Enter Short Desciption"
                                    ...
                                    <div class="mb-3 mt-3">
                                        ...
                                        <textarea name="description" class="form-control" placeholder="Enter Desciption" wire:model="description"></textarea>
                                        @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
